...
<html lang="<?php echo $language; ?>">
  ...
  <body>
    <?php if ($language === 'bg'): ?>
      <p class="text"><strong>Добре дошли до моя MAMP</strong></p>
      <p class="text">Ако виждате този сайт, означава, че правилно сте инсталирали МАМР.</p>
      <p class="text">
        ...
        Протокол: <samp><?php echo ((isset($_SERVER['HTTPS']) === true && $_SERVER['HTTPS'] !== 'off') ? '<abbr lang="en" title="Hypertext Transfer Protocol Secure">https</abbr>' : '<abbr lang="en" title="Hypertext Transfer Protocol">http</abbr>'); ?></samp><br>
        <abbr lang="en" title="Hypertext Preprocessor">PHP</abbr> <samp><?php echo phpversion(); ?></samp>
      </p>
      <p class="text" id="footnote-1"><small><sup>1</sup> Файл: <samp>index.php</samp></small></p>
      <hr>
      <p class="text">This page in: <?php echo $switch_language; ?></p>
    <?php elseif ($language == 'en'): ?>
      <p class="text"><strong>Welcome to My MAMP beibiiiiiiiiiii</strong></p>
      <p class="text">If you can see this page, MAMP has been properly configured by Eva &amp; launched and is now all set to serve your web content. This placeholder page<sup><a href="#footnote-1">1</a></sup> should be replaced or deleted.</p>
      <p class="text">
      ...
      <hr>
      <p class="text">Тази страница на: <?php echo $switch_language; ?></p>
    <?php endif; ?>
  </body>
</html>
